/**
 * Meta-supported languages for WhatsApp template creation.
 * Format: { value: language code, label: display name }
 * @see https://developers.facebook.com/docs/whatsapp/api/messages/message-templates
 */
export const metaLanguages: { value: string; label: string }[] = [
